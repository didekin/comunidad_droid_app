...
public class IncidSeeOpenByComuAcTest_1 {
    ...
    public void setUp() throws Exception
    {
        ...
        fragment = (IncidSeeByComuListFr) activity.getSupportFragmentManager()
                .findFragmentByTag(incid_see_by_comu_list_fr_tag);
        controller = (ControllerIncidOpenSee) fragment.controllerSeeIncids;
    ...
    public void testOnCreate_2() throws Exception
    {
        ...
        assertThat(fragment.comunidadSelectedIndex, is(1));
