...
public class IncidSeeOpenByComuAcTest_2 {
    ...
    public void setUp() throws Exception
    {
        ...
        IncidSeeByComuListFr fragmentByTag = (IncidSeeByComuListFr) mActivity.getSupportFragmentManager()
                .findFragmentByTag(incid_see_by_comu_list_fr_tag);
        controller = (ControllerIncidOpenSee) fragmentByTag.controllerSeeIncids;
