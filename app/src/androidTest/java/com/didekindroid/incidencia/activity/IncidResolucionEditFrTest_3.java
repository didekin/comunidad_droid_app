...
public class IncidResolucionEditFrTest_3 {
    ...
    public IntentsTestRule<IncidResolucionRegEditSeeAc> intentRule = new IntentsTestRule<IncidResolucionRegEditSeeAc>(IncidResolucionRegEditSeeAc.class) {
         ...
         * 2. A resolucion in intent.
         * 3. The incidencia is now closed in BD.
         * 4. Resolucion without avances.
         * */
        @Override
    ...
    public void setUp() throws Exception
    {
        ...
        // Precondition: resolución in intent.
        ...
        // Precondition: incidencia is closed in BD.  TODO: empezar con esto.
