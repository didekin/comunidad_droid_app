...
public class IncidBundleKeyTest {
    ...
    {
        assertThat(COMUNIDAD_LIST_OBJECT.key, is(IncidBundleKey.class.getName()
                .concat(".")
                .concat(COMUNIDAD_LIST_OBJECT.name())));
        assertThat(COMUNIDAD_LIST_INDEX.key, is(IncidBundleKey.class.getName()
                .concat(".")
                .concat(COMUNIDAD_LIST_INDEX.name())));
        assertThat(COMUNIDAD_SEARCH.key, is(IncidBundleKey.class.getName()
                .concat(".")
                .concat(COMUNIDAD_SEARCH.name())));
        assertThat(COMUNIDAD_ID.key, is(IncidBundleKey.class.getName()
                .concat(".")
                .concat(COMUNIDAD_ID.name())));
        assertThat(USERCOMU_LIST_OBJECT.key, is(IncidBundleKey.class.getName()
                .concat(".")
