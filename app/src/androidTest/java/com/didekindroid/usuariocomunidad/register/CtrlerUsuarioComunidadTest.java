...
public class CtrlerUsuarioComunidadTest {
    ...
    public void test_UserComuAndComuRegistered() throws Exception
    {
        ...
        assertThat(userComuDao.seeUserComusByUser().size(), is(2));
    ...
    public void test_UserComuDeleted() throws Exception
    {
        ...
        controller.userComuDeleted(userComuDao.seeUserComusByUser().get(0).getComunidad()).test().assertResult(IS_USER_DELETED);
    }
