...
import static contrib.DrawerMatchers.isClosed;
import static contrib.DrawerMatchers.isOpen;
  ...
  private static ViewAction registerListener() {
    return new ViewAction() {
      ...
      public void perform(UiController uiController, View view) {
        ...
        DrawerLayout.DrawerListener existingListener = getDrawerListener(drawer);
