...
public final class IncidenciaTestUtils {
    ...
    static final String AVANCE_DEFAULT_DES = "Avance_1";
    static final int COSTE_ESTIM_DEFAULT = 1122;
    ...
    static Incidencia doIncidenciaWithId(long incidenciaId, String descripcion, long comunidadId, short ambitoId)
    {
        return new Incidencia.IncidenciaBuilder()
