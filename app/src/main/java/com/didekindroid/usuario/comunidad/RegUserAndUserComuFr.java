...
import com.didekindroid.usuario.common.UsuarioComunidadFiller;
...
public class RegUserAndUserComuFr extends Fragment {
    ...
    private void registroNuevoUsuarioComunidad(final ComunidadBean comunidadBean)
    {
        ...
        UsuarioComunidadBean usuarioComunidadBean = UsuarioComunidadFiller.makeUsuarioComunidadBeanFromView
