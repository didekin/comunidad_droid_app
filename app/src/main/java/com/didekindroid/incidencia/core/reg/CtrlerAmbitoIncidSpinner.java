...
final class CtrlerAmbitoIncidSpinner extends CtrlerSpinner<AmbitoIncidValueObj> {
    ...
    static CtrlerAmbitoIncidSpinner newCtrlerAmbitoIncidSpinner(ViewerSelectableIf<Spinner, CtrlerSpinnerIf> viewerIn)
    {
    ...
    static Single<List<AmbitoIncidValueObj>> ambitoIncidList(final ViewerIf<Spinner, ? extends ControllerIf> viewer)
    {
