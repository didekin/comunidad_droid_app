...
public class IncidEditNoPowerFr extends Fragment implements ImportanciaSpinnerSettable {
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        TextView mSeeImportanciaView = (TextView) getView().findViewById(R.id.incid_importancia_otros_view);
        mSeeImportanciaView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Timber.d("mSeeImportanciaView.onClick()");
                Intent intent = new Intent(getContext(), IncidSeeUserComuImportanciaAc.class);
                intent.putExtra(INCIDENCIA_OBJECT.key, getIncidencia());
    ...
    void modifyIncidImportancia()
    {
        ...
        try {
            IncidImportancia incidImportancia = mIncidImportanciaBean.makeIncidImportancia(
                    errorMsg, getResources(), mIncidImportancia);
        ...
        protected Integer doInBackground(IncidImportancia... incidImportancias)
        {
            ...
            try {
                ...
                if (mIncidImportancia.getImportancia() == 0) {
                    ...
                    rowInserted = incidenciaDao.modifyIncidImportancia(incidImportancias[0]);
                }
            } catch (UiException e) {
                uiException = e;
            }
