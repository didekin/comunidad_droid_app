 ...
 * fragment.
 */
public class IncidSeeClosedByComuAc extends AppCompatActivity implements ManagerIncidSeeIf<Bundle> {

    IncidSeeByComuListFr<Bundle> fragmentList;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (savedInstanceState != null) {
            ...
            fragmentList = (IncidSeeByComuListFr<Bundle>) getSupportFragmentManager().findFragmentByTag(incid_see_by_comu_list_fr_tag);
            return;
        }

        fragmentList = new IncidSeeByComuListFr<>();
    ...
    public ControllerIncidSeeIf getController()
    {
        ...
        return new ControllerIncidCloseSee(fragmentList);
    }
}
