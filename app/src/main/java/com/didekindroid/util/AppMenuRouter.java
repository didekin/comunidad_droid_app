...
import com.didekindroid.usuario.password.PasswordChangeAppAc;
...
public final class AppMenuRouter {
    ...
    static {
        ...
        routerMap.put(R.id.delete_me_ac_mn, DeleteMeAppAc.class);
        routerMap.put(R.id.login_ac_mn, LoginAppAc.class);
        routerMap.put(R.id.password_change_ac_mn, PasswordChangeAppAc.class);
