...
public class GcmResponse {
    ...
    GcmResponse(int canonical_ids, int multicast_id, int success, int failure, Result[] results)
    {
...
//    ==================================  INNER CLASSES ================================
    ...
    public static final class Result {
        ...
        Result(String error, String message_id, String registration_id)
        {
            this.error = error;
