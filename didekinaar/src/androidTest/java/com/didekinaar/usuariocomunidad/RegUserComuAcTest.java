...
public class RegUserComuAcTest {
    ...
    public void testOnCreate() throws Exception
    {
        ...
        assertThat(comunidad2, Matchers.is(UsuarioTestUtils.COMU_TRAV_PLAZUELA_PEPE.getComunidad()));
    ...
    public void testOnclick_1()
    {
        ...
        UsuarioTestUtils.typeUserComuData("portal?", "select *", "planta!", "puerta_1");
