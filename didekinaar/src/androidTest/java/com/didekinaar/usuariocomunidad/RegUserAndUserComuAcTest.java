...
public class RegUserAndUserComuAcTest {
    ...
    @Test
    public void testRegisterUserAndUserComu_1() throws UiAarException
    {
        ...
        UsuarioTestUtils.typeUserComuData("portalA", "escC", "plantaB", "puerta_1", PRO, PRE);
    ...
    public void testLoginMn_WithToken() throws InterruptedException, UiAarException, IOException
    {
        ...
        UserMenuTestUtils.LOGIN_AC.checkMenuItem_WTk(activity);
        checkUp(activityLayoutId);
    }
}
