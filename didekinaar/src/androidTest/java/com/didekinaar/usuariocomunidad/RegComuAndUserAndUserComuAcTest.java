...
import static com.didekinaar.testutil.CleanUserEnum.CLEAN_TK_HANDLER;
...
public class RegComuAndUserAndUserComuAcTest {
    ...
    public void testMakeUsuarioBeanFromView_OK() throws Exception
    {
        ...
        // Data for Usuario.
        UsuarioTestUtils.typeUserData("yo@email.com", "alias1", "password1", "password1");
        ...
        UsuarioTestUtils.validaTypedUsuario(usuario, "yo@email.com", "alias1", "password1");
    }
    ...
    public void testMakeUsuarioComunidadBeanFromView_OK() throws InterruptedException
    {
        ...
        UsuarioTestUtils.typeComunidadData("Callejon", "Valencia", "Castellón/Castelló", "Chilches/Xilxes", "nombre via One", "123", "Tris");
        // Data for UsuarioComunidadBean.
        Thread.sleep(1000);
        UsuarioTestUtils.typeUserComuData("port2", "escale_b", "planta-N", "puerta5", RolUi.PRE, RolUi.INQ);
        ...
        UsuarioTestUtils.validaTypedComunidad(usuarioComunidad.getComunidad(), "Callejon", (short) 12, (short) 53, "nombre via One", (short) 123, "Tris");
        UsuarioTestUtils.validaTypedUsuario(usuarioComunidad.getUsuario(), "yo@email.com", "alias1", "password1");
        UsuarioTestUtils.validaTypedUsuarioComunidad(usuarioComunidad, "port2", "escale_b", "planta-N", "puerta5", "pre,inq");
    }
    ...
    @Test
    public void testRegComuAndUserComuAndUser_OK() throws UiAarException, InterruptedException
    {
        mActivity = mActivityRule.launchActivity(new Intent());
        ...
        UsuarioTestUtils.typeUserComuData("port2", "escale_b", "planta-N", "puerta5", RolUi.PRE, RolUi.INQ);
        // Usuario.
        UsuarioTestUtils.typeUserData(UsuarioTestUtils.USER_JUAN2.getUserName(), UsuarioTestUtils.USER_JUAN2.getAlias(), UsuarioTestUtils.USER_JUAN2.getPassword(), UsuarioTestUtils.USER_JUAN2.getPassword());
    ...
    @Test
    public void testLoginMn_NoToken() throws InterruptedException, UiAarException
    {
        mActivity = mActivityRule.launchActivity(new Intent());
        assertThat(isRegisteredUser(mActivity), is(false));
        assertThat(TKhandler.getAccessTokenInCache(), nullValue());

        UserMenuTestUtils.LOGIN_AC.checkMenuItem_NTk(mActivity);
        checkUp(activiyLayoutId);
    }

    @Test
    public void testLoginMn_WithToken() throws InterruptedException, UiAarException, IOException
    {
        ...
        UserMenuTestUtils.LOGIN_AC.checkMenuItem_WTk(mActivity);
        checkUp(activiyLayoutId);
    }
