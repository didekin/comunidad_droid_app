...
//    =================================================================================================================
    ...
    public void testViewData() throws InterruptedException
    {
        ...
        UsuarioTestUtils.validaTypedUsuarioComunidad(userComu, UsuarioTestUtils.COMU_PLAZUELA5_JUAN.getPortal(), UsuarioTestUtils.COMU_PLAZUELA5_JUAN.getEscalera(), UsuarioTestUtils.COMU_PLAZUELA5_JUAN.getPlanta(),
                UsuarioTestUtils.COMU_PLAZUELA5_JUAN.getPuerta(), UsuarioTestUtils.COMU_PLAZUELA5_JUAN.getRoles());
