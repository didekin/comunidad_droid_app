...
public class SeeUserComuByUserAcTest {
    ...
    public IntentsTestRule<SeeUserComuByUserAc> intentRule = new IntentsTestRule<SeeUserComuByUserAc>(SeeUserComuByUserAc.class) {
        ...
        {
            try {
                AarActivityTestUtils.regSeveralUserComuSameUser(UsuarioTestUtils.COMU_ESCORIAL_PEPE, UsuarioTestUtils.COMU_PLAZUELA5_PEPE, UsuarioTestUtils.COMU_LA_FUENTE_PEPE);
...
//  ================================================================================================================
    ...
    public void testOnCreateAndNavigateUp() throws Exception
    {
        ...
        onData(Matchers.is(UsuarioTestUtils.COMU_LA_FUENTE_PEPE)).check(matches(isDisplayed())).perform(click());
    ...
    public void testViewData_1() throws InterruptedException
    {
        ...
        assertThat(adapter.getItem(0), Matchers.is(UsuarioTestUtils.COMU_LA_FUENTE_PEPE));
        assertThat(adapter.getItem(1), Matchers.is(UsuarioTestUtils.COMU_ESCORIAL_PEPE));
        assertThat(adapter.getItem(2), Matchers.is(UsuarioTestUtils.COMU_PLAZUELA5_PEPE));
    ...
    {
        onData(Matchers.is(UsuarioTestUtils.COMU_LA_FUENTE_PEPE))
                .onChildView(
                        allOf(
                                ViewMatchers.withId(R.id.nombreComunidad_view),
                                ViewMatchers.withText(UsuarioTestUtils.COMU_LA_FUENTE.getNombreComunidad())
                        )
                )
        ...
        onData(Matchers.is(UsuarioTestUtils.COMU_LA_FUENTE_PEPE))
                .onChildView(
                        allOf(
                                ...
                                withText(RolUi.formatRolToString(UsuarioTestUtils.COMU_LA_FUENTE_PEPE.getRoles(), mActivity.getResources()))
                        )
                )
                .check(matches(isDisplayed()));

        onData(Matchers.is(UsuarioTestUtils.COMU_ESCORIAL_PEPE))
                .onChildView(
                        allOf(
                                ViewMatchers.withId(R.id.nombreComunidad_view),
                                ViewMatchers.withText(UsuarioTestUtils.COMU_EL_ESCORIAL.getNombreComunidad())
                        )
                )
                .check(matches(isDisplayed()));
        onData(Matchers.is(UsuarioTestUtils.COMU_ESCORIAL_PEPE))
                .onChildView(
                        allOf(
                                ViewMatchers.withId(R.id.usercomu_item_roles_txt),
                                withText(RolUi.formatRolToString(UsuarioTestUtils.COMU_ESCORIAL_PEPE.getRoles(), mActivity.getResources()))
                        )
                )
                .check(matches(isDisplayed()));

        onData(Matchers.is(UsuarioTestUtils.COMU_PLAZUELA5_PEPE))
                .onChildView(
                        allOf(
                                ViewMatchers.withId(R.id.nombreComunidad_view),
        ...
        onData(Matchers.is(UsuarioTestUtils.COMU_PLAZUELA5_PEPE))
                .onChildView(
                        allOf(
                                ViewMatchers.withId(R.id.usercomu_item_roles_txt),
                                withText(RolUi.formatRolToString(UsuarioTestUtils.COMU_PLAZUELA5_PEPE.getRoles(), mActivity.getResources()))
                        )
                )
                .check(matches(isDisplayed()));
    ...
    {
        UserMenuTestUtils.USER_DATA_AC.checkMenuItem_WTk(mActivity);
        checkUp(fragmentLayoutId);
    }
