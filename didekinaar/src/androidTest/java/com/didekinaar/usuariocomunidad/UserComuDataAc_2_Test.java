...
public class UserComuDataAc_2_Test {
    ...
    public IntentsTestRule<UserComuDataAc> intentRule = new IntentsTestRule<UserComuDataAc>(UserComuDataAc.class) {
        ...
        protected void beforeActivityLaunched()
        {
            ...
            UsuarioComunidad userComu = UsuarioTestUtils.makeUsuarioComunidad(mUsuarioComunidad.getComunidad(), UsuarioTestUtils.USER_PEPE,
        ...
        protected Intent getActivityIntent()
        {
            try {
                ...
                assertThat(UsuarioTestUtils.COMU_REAL_JUAN.hasAdministradorAuthority(), is(false));
    ...
    @Test
    public void testDeleteUserComu_2() throws UiAarException
    {
