...
import static com.didekinaar.testutil.CleanUserEnum.CLEAN_JUAN2;
...
//    =================================================================================================================
    ...
    public void testOneUserComunidadOne() throws Exception
    {
        ...
        checkUserComu(userComu, UsuarioTestUtils.COMU_TRAV_PLAZUELA_PEPE);

        cleanOptions(CLEAN_PEPE);
    }

    @Test
    public void testThreeUsersInComunidad() throws IOException, UiAarException, InterruptedException
    {
        ...
        AarUserComuServ.regUserAndUserComu(new UsuarioComunidad.UserComuBuilder(
                ...
                UsuarioTestUtils.COMU_PLAZUELA5_PEPE.getUsuario()).userComuRest(UsuarioTestUtils.COMU_PLAZUELA5_PEPE)
                .build()).execute();
        // No escalera.
        ...
        checkUserComu(juan1, UsuarioTestUtils.COMU_PLAZUELA5_JUAN);
        UsuarioComunidad juan2 = mAdapter.getItem(1);
        checkUserComu(juan2, userComuNew);
        UsuarioComunidad pepe = mAdapter.getItem(2);
        checkUserComu(pepe, UsuarioTestUtils.COMU_PLAZUELA5_PEPE);

        // Header.
        onView(ViewMatchers.withId(R.id.see_usercomu_by_comu_list_header))
                .check(matches(withText(containsString(UsuarioTestUtils.COMU_PLAZUELA5_JUAN.getComunidad().getNombreComunidad()))));
    ...
    @Test
    public void testNoPortalEscalera() throws IOException, UiAarException, InterruptedException
    {
        AarActivityTestUtils.signUpAndUpdateTk(UsuarioTestUtils.COMU_PLAZUELA5_JUAN);
        doSetUp();
        launch();
        ...
        checkUser(UsuarioTestUtils.COMU_PLAZUELA5_JUAN.getUsuario().getAlias(), UsuarioTestUtils.COMU_PLAZUELA5_JUAN.getUsuario().getUserName());
        checkRole(formatRolToString(UsuarioTestUtils.COMU_PLAZUELA5_JUAN.getRoles(), mActivity.getResources()));
        checkPlantaView(UsuarioTestUtils.COMU_PLAZUELA5_JUAN.getPlanta());
        checkPuertaView(UsuarioTestUtils.COMU_PLAZUELA5_JUAN.getPuerta());

        cleanOptions(CLEAN_JUAN);
    }

    @Test
    public void testNoEscalera() throws UiAarException, IOException, InterruptedException
    {
        UsuarioComunidad usuarioComunidad = new UsuarioComunidad.UserComuBuilder(
                UsuarioTestUtils.COMU_LA_PLAZUELA_5,
                UsuarioTestUtils.USER_JUAN2)
                .portal("portal B")
                .planta("B")
                .puerta("123")
    ...
    @Test
    public void testTodo() throws IOException, UiAarException, InterruptedException
    {
        ...
        checkUser(UsuarioTestUtils.COMU_PLAZUELA5_PEPE.getUsuario().getAlias(), UsuarioTestUtils.COMU_PLAZUELA5_PEPE.getUsuario().getUserName());
        checkRole(formatRolToString(UsuarioTestUtils.COMU_PLAZUELA5_PEPE.getRoles(), mActivity.getResources()));
        checkPortalView(UsuarioTestUtils.COMU_PLAZUELA5_PEPE.getPortal());
        checkEscaleraView(UsuarioTestUtils.COMU_PLAZUELA5_PEPE.getEscalera());
        checkPlantaView(UsuarioTestUtils.COMU_PLAZUELA5_PEPE.getPlanta());
        checkPuertaView(UsuarioTestUtils.COMU_PLAZUELA5_PEPE.getPuerta());
...
//    =============================== HELPER METHODS ========================================
    ...
    private void doSetUp() throws UiAarException
    {
    ...
    {
        UsuarioTestUtils.validaTypedUsuarioComunidad(userComuOut, userComuIn.getPortal(), userComuIn.getEscalera(), userComuIn.getPlanta(),
