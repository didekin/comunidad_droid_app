...
public class ComuSearchAc_2_Test {
    ...
    @Test
    public void testWithResultsAndUp() throws InterruptedException, UiAarException, IOException
    {
        //With token.
    ...
    @Test
    public void testWithResultsAndBack() throws InterruptedException, UiAarException, IOException
    {
        //With token.
        AarActivityTestUtils.signUpAndUpdateTk(UsuarioTestUtils.COMU_REAL_JUAN);
    ...
    @Test
    public void testNoResults_2_Up() throws InterruptedException, UiAarException, IOException
    {
        // With token.
        AarActivityTestUtils.signUpAndUpdateTk(UsuarioTestUtils.COMU_ESCORIAL_JUAN);
        intentRule.launchActivity(new Intent());
    ...
    @Test
    public void testNoResults_2_Back() throws InterruptedException, UiAarException, IOException
    {
        // With token.
        AarActivityTestUtils.signUpAndUpdateTk(UsuarioTestUtils.COMU_ESCORIAL_JUAN);
        intentRule.launchActivity(new Intent());
