...
class ComunidadDbHelper extends SQLiteOpenHelper {
    ...
    ComunidadDbHelper(Context context)
    {
...
//    ======================================
    ...
    Cursor getMunicipiosByPrId(short prId)
    {
...
//    ======================================
    ...
    Cursor getProvinciasByCA(short caId)
    {
        ...
        String whereClause = ComunidadDataDb.Provincia.ca_id + " = ?";
