...
public final class AarUserComuService implements UsuarioComunidadEndPoints {

    public static final AarUserComuService AarUserComuServ = new AarUserComuService();
    private final UsuarioComunidadEndPoints endPoint;

    private AarUserComuService()
    {
...
//  =============================================================================
    ...
    public int deleteUserComu(long comunidadId) throws UiAarException
    {
    ...
    public UsuarioComunidad getUserComuByUserAndComu(long comunidadId) throws UiAarException
    {
    ...
    public boolean isOldestOrAdmonUserComu(long comunidadId) throws UiAarException
    {
    ...
    public int modifyComuData(Comunidad comunidad) throws UiAarException
    {
    ...
    public int modifyUserComu(UsuarioComunidad userComu) throws UiAarException
    {
    ...
    public boolean regComuAndUserComu(UsuarioComunidad usuarioComunidad) throws UiAarException
    {
    ...
    public int regUserComu(UsuarioComunidad usuarioComunidad) throws UiAarException
    {
    ...
    public List<UsuarioComunidad> seeUserComusByComu(long idComunidad) throws UiAarException
    {
    ...
    public List<UsuarioComunidad> seeUserComusByUser() throws UiAarException
    {
